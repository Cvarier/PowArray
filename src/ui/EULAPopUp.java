...
public class EULAPopUp extends JFrame {
    ...
    private static Preferences prefs = Preferences
            .userNodeForPackage(ui.EULAPopUp.class);

    private static String openEULA = "EULAOPEN";
    ...
    public EULAPopUp() {
        ...
        appIcon = new ImageIcon(
                EULAPopUp.class.getResource("/ui/PowArray Icon.png"));

        setResizable(false);
        setIconImage(appIcon.getImage());
        setTitle("PowArray v1.0.1 - EULA");
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setBounds(1075, 100, 501, 585);
        setResizable(false);
        ...
        addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent e) {
                prefs.putBoolean(openEULA, false);
            }
        });
